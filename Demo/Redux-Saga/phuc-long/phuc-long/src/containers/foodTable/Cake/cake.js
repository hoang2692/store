...
import '../../../App.css';
// import Imge from "../assets/images/index";
class Cake extends Component{
    render(){
        return(
    <div>
        <img className="img-bia"  src="../../img/phucbontu_hanhnhan.png" alt="bakery"></img>
	    <div className="page-heading">
              ...
              <a href="true" className="active">Sản phẩm</a></span>
				...
				<div className="logolatra">
                    <img  src="../../img/phucbontu_hanhnhan.png" style={{width:'30%'}} alt="icon_latra"/>
				</div>
                <ul className="nav nav-pills mb-3 align-just-center" id="pills-tab" role="tablist">
                    ...
                    <li className="nav-item">
                        <a style={{width: '200px',textAlign: 'center'}} className="nav-link active" id="pills-profile-tab" href='/sanpham/monman' role="tab" aria-controls="pills-profile" aria-selected="false">
                                DINNING OFFER
                        </a> 
                    </li>
                    <li className="nav-item">
                        <a style={{width: '200px',textAlign: 'center'}} className="nav-link" id="pills-contact-tab" href='/sanpham/bakery' role="tab" aria-controls="pills-contact" aria-selected="false">
                                BAKERY
                        </a> 
                    </li>
                </ul>    
