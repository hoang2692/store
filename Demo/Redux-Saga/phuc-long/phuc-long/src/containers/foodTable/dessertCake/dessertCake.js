  ...
  render() {
    return (
      <div>
        <img
          className="img-bia"
          src="../../img/3c1de90e955d1a-8ed98f521583690431954887e772tuyendung1.jpg"
          alt="bakery"
        ></img>
            ...
            <div className="row">
              <div className=" col-sm-3 col-xs-6  product-item ">
                <div className="item-wrapper">
                  ...
                  <img
                    ...
                    src="../../img/452326c94afd94-raspberryredvelvet.jpg"
              ...
              <div className=" col-sm-3 col-xs-6  product-item ">
                <div className="item-wrapper">
                  ...
                  <img
                    className="item-img img-responsive center-block lazy"
                    src="../../img/f041af9c13fefd-strawberrycheesecake.jpg"
              ...
              <div className=" col-sm-3 col-xs-6  product-item ">
                <div className="item-wrapper">
                  <img
                    className="item-img img-responsive center-block lazy"
                    src="../../img/044784e7d82d50-hudacthom.png"
                    alt="Mứt Đác Thơm"
                  />
                  <div className="item-info">
              ...
              <div className=" col-sm-3 col-xs-6  product-item ">
                <div className="item-wrapper">
                  <img
                    className="item-img img-responsive center-block lazy"
                    src="../../img/05602666df6293-hudaccam.png"
                    alt="Mứt Đác Cam"
                  />
                  <div className="item-info">
              ...
              <div className=" col-sm-3 col-xs-6  product-item ">
                <div className="item-wrapper">
                  <img
                    className="item-img img-responsive center-block lazy"
                    src="../../img/f22454a67e794c-pannacottastrawberry.png"
              ...
              <div className=" col-sm-3 col-xs-6  product-item ">
                <div className="item-wrapper">
                  <img
                    className="item-img img-responsive center-block lazy"
                    src="../../img/45d4756da972cd-banhphap_0007s_0001_coffeegeatcaux.jpg"
                    alt="Coffee Gateaux"
                  />
                  <div className="item-info">
              ...
              <div className=" col-sm-3 col-xs-6  product-item ">
                <div className="item-wrapper">
                  <img
                    className="item-img img-responsive center-block lazy"
                    src="../../img/6428ee2a20ef1e-banhphap_0006s_0001_greenteachocolate.jpg"
              ...
              <div className=" col-sm-3 col-xs-6  product-item ">
                <div className="item-wrapper">
                  <img
                    className="item-img img-responsive center-block lazy"
                    src="../../img/0d80107cb60a8d-banhphap_0001s_0001_appledanish.jpg"
                    alt="Apple Danish"
                  />
                  <div className="item-info">
              ...
              <div className=" col-sm-3 col-xs-6  product-item ">
                <div className="item-wrapper">
                  <img
                    className="item-img img-responsive center-block lazy"
                    src="../../img/fda042835935bc-banhphap_0002s_0000_raisin.jpg"
                    alt="Raisin Danish"
                  />
                  <div className="item-info">
              ...
              <div className=" col-sm-3 col-xs-6  product-item ">
                <div className="item-wrapper">
                  <img
                    className="item-img img-responsive center-block lazy"
                    src="../../img/a1c4d22a41ec76-banhphap_0003s_0000_chocobuttercroissant.jpg"
              ...
              <div className=" col-sm-3 col-xs-6  product-item ">
                <div className="item-wrapper">
                  <img
                    className="item-img img-responsive center-block lazy"
                    src="../../img/01b9696b860549-banhphap_0000s_0001_buttercroissant.jpg"
              ...
              <div className=" col-sm-3 col-xs-6  product-item ">
                <div className="item-wrapper">
                  <img
                    className="item-img img-responsive center-block lazy"
                    src="../../img/2287e22240ad3b-banhphap_0008s_0001_brownie.jpg"
                    alt="Brownie Pax"
                  />
                  <div className="item-info">
              ...
              <div className=" col-sm-3 col-xs-6  product-item ">
                <div className="item-wrapper">
                  <img
                    className="item-img img-responsive center-block lazy"
                    src="../../img/f7e6116eef86b6-banhphap_0005s_0000_tiramisu.jpg"
                    alt="Tiramisu"
                  />
                  <div className="item-info">
              ...
              <div className=" col-sm-3 col-xs-6  product-item ">
                <div className="item-wrapper">
                  <img
                    className="item-img img-responsive center-block lazy"
                    src="../../img/28f78f176da1fb-banhphap_0004s_0000_passioncheese.jpg"
              ...
              <div className=" col-sm-3 col-xs-6  product-item ">
                <div className="item-wrapper">
                  <img
                    className="item-img img-responsive center-block lazy"
                    src="../../img/e8912187484de9-banhphap_0009s_0002_montecarlo.jpg"
