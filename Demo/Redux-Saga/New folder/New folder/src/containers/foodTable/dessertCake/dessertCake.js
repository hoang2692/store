          ...
          <div class="container ">
            <div className="row" style={{ justifyContent: "center" }}>
              ...
              <div className="tab" id="pills-tabContent">
                ...
                >
                  <div className="row"  style={{alignItems:"center",justifyItems:"center",}}>
                  ...
                  {data.map((e, index) => {
                    return (
                    <div className="col-lg-3 col-sm-6 align-just-center align-items-center" key={index}>
                    <div className="card align-items-center align-text-center pt-3">
                      <span
                        style={{
                          color: "white",
...
export default connect(mapStateToProps, mapDispatchToProps)(DessertCake);
