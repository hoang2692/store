...
class ThucUong extends Component {
    render() {
        return (
            <div>
            <img style={{ width: '100%'}} src="../../img/hinhdau.jpg" alt="cà phê"></img>
            ...
            <div className="row align-text-center">
                ...
                <div className="row justify-content-center"><center>
                    ...
                    <a href="true" className="active">Thức uống</a></span>
                    </div></center>
                </div>
                <h1>THỨC UỐNG</h1>
                <div>
                ...
                <div className="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    ...
                    <div className="row align-items-center  align-just-center align-items-center  pt-5">
                        <div className="col-lg-6 background">
                            <div className="row pt-3 pb-3">
                                ...
                                <div className="col-sm-6" style={{textAlign: 'right'}}>
                                    ...
                                    <img className="img-banner" src="../../img/phucbontu_hanhnhan.png" alt="phuc bon tu" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-3 col-sm-6 align-just-center align-items-center">
                            ...
                            <div className="card align-items-center align-text-center pt-3">
                                <span style={{color: 'white', backgroundColor: '#0C713D', fontSize: '12px',right: '10px',position: 'absolute',padding: '5px 6px',fontWeight:900,borderRadius: '3px' }}>Món mới</span>
                                <img className="card-img-top" src="../../img/phucbontu_hanhnhan.png" alt="phuc bon tu" />
                        ...
                        <div className="col-lg-3 col-sm-6 align-just-center align-items-center">
                            <div className="card align-items-center align-text-center pt-3" >
                                <span style={{color: 'white', backgroundColor: '#0C713D', fontSize: '12px',right: '10px',position: 'absolute',padding: '5px 6px',fontWeight:900,borderRadius: '3px' }}>Món mới</span>
                                <img className="card-img-top" src="../../img/hongtra_cam.png" alt="hong tra" />
                                <div className="card-body">
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-3 col-sm-6 align-just-center align-items-center">
                            <div className="card align-items-center align-text-center pt-3" >
                                <span style={{color: 'white', backgroundColor: '#0C713D', fontSize: '12px',right: '10px',position: 'absolute',padding: '5px 6px',fontWeight:900,borderRadius: '3px' }}>Món mới</span>
                                <img className="card-img-top" src="../../img/laidac_thom.png" alt="hong tra" />
                                <div className="card-body">
                        ...
                        <div className="col-lg-3 col-sm-6 align-just-center align-items-center">
                            <div className="card align-items-center align-text-center pt-3" >
                                <img className="card-img-top" src="../../img/cf_sua.png" alt="Cafa" />
                                <div className="card-body">
                        ...
                        <div className="col-lg-3 col-sm-6 align-just-center align-items-center">
                            <div className="card align-items-center align-text-center pt-3" >
                                <img className="card-img-top" src="../../img/dao_daxay.png" alt="hong tra" />
                                <div className="card-body">
                        ...
                        <div className="col-lg-3 col-sm-6 align-just-center align-items-center">
                            <div className="card align-items-center align-text-center pt-3" >
                                <img className="card-img-top" src="../../img/hoahong.png" alt="rose" />
                                <div className="card-body">
                        ...
                        <div className="col-lg-3 col-sm-6 align-just-center align-items-center">
                            <div className="card align-items-center align-text-center pt-3" >
                                <img className="card-img-top" src="../../img/olong_sua.png" alt="hong tra" />
                                <div className="card-body">
                        ...
                        <div className="col-lg-3 col-sm-6 align-just-center align-items-center">
                            <div className="card align-items-center align-text-center pt-3" >
                                <img className="card-img-top" src="../../img/olongdau.png" alt="olong" />
                                <div className="card-body">
                        ...
                        <div className="col-lg-3 col-sm-6 align-just-center align-items-center">
                            <div className="card align-items-center align-text-center pt-3" >
                                <img className="card-img-top" src="../../img/orio.png" alt="hong tra" />
                                <div className="card-body">
                        ...
                        <div className="col-lg-3 col-sm-6 align-just-center align-items-center">
                            <div className="card align-items-center align-text-center pt-3" >
                                <img className="card-img-top" src="../../img/socola.png" alt="hong tra" />
                                <div className="card-body">
