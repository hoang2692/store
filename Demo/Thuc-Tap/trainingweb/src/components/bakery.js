	    ...
	    <div className="page-heading">
              ...
              <a href="true" className="active">Sản phẩm</a></span>
                ...
                <ul className="nav nav-pills mb-3 align-just-center" id="pills-tab" role="tablist">
                    ...
                    <li className="nav-item">
                        <a style={{width: '200px',textAlign: 'center'}} className="nav-link active" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">
                                BACKERY
                        </a> 
                    </li>
                </ul>    
