...
export default class Render extends Component {
  ...
  render() {
    ...
    return (
      <div className="container-fluname pt-5">
        <div
          className="container"
          style={{
        ...
        >
          ...
          <div className="form-group col-md-7">
            <span className="from-text">
              {" "}
              <i>
                (Số điện thoại, ngày sinh nhật và địa chỉ email sau khi tạo tài
                khoản sẽ không thể thay đổi, vui lòng liên hệ bộ phận CSKH ủa
                chúng tôi tại
                <b className="b">(+84 28) 6263 0377 - 78 </b>
                (số máy lẻ <b className="b">604</b>) nếu bạn có bất kỳ thắc mắc
                nào.)
              </i>
            </span>
          </div>
          <form className="form-DK">
            ...
            <div className="row">
              ...
              <div className="form-group col-md-12">
                ...
                <p className="from-text1">
                  (Các thông tin dưới đây là không bắt buộc, nhưng nhờ vào thông
                  tin này, chúng tôi sẽ gởi những ưu đãi phù hợp với bạn nhất )
                </p>
              </div>
            </div>
          </form>
          <div>
                ...
                <div className="form-row">
                  <div className="form-group col-md-4">
                    <label style={{ fontSize: "14px" }}>
                      Các cửa hàng phúc long bạn yêu thích là:
                    </label>
                    <select name="inputState" className="form-control">
                      <option>Chọn</option>
                  ...
                  <div className="form-group col-md-4">
                    <label style={{ fontSize: "14px" }}>
                      Món nước bạn yêu thích là:
                    </label>
                    <input type="text" className="form-control" name="input1" />
                  </div>
                </div>
              </form>
            ) : (
            ...
            <div style={{ textAlign: "center", borderTop: "1px solname #ddd" }}>
              <button
            ...
            <div className="form-group  ">
              <p className="from-text1 col-md-12">
                Khi bấm Hoàn tất Đăng ký Thẻ Thành viên Phúc Long, bạn đồng ý bị
                ràng buộc bởi những Điều khoản & Điều kiện sử dụng này và tất cả
                các Điều khoản được kết hợp bằng việc tham chiếu
              </p>
              <div style={{ marginLeft: "15px" }}>
                <input className="form-check-input" type="checkbox" value="" />
                <label className="form-check-label">
                  {" "}
                  Đồng ý nhận thư từ chúng tôi.
                </label>
              </div>
            </div>
            <div style={{ borderTop: "1px solname #ddd" }}>
              <button
                style={{
                  display: "block",
                  margin: "1.5rem auto",
                  backgroundColor: "#0d713d",
                  color: "White",
                }}
                type="button"
                className="btn"
