...
const mapDispatchToProps = (dispatch) => {
  return {
    getData: () =>dispatch({type: "GET_MER_SUV_REQUEST"}),
    onDelete: (id) => dispatch({type: "DELETE_MER_SUV_REQUEST", id:id}),
    AddSanPham: (data) =>dispatch({type: "ADD_MER_SUV_REQUEST", data}),
    getEditData: (id) => dispatch({type:"GETEDIT_MER_SUV_REQUEST", id}),
    update: (data) =>dispatch({type: "UPDATE_MER_SUV_REQUEST", data})
  };
};
