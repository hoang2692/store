...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    ondelete: (id) =>dispatch({type: "DELETE_LAMBOR_SUV_REQUEST", id:id}),
    AddSanPham: (data) =>dispatch({type: "ADD_LAMBOR_SUV_REQUEST", data}),
    getEditData: (id) => dispatch({type:"GETEDIT_LAMBOR_SUV_REQUEST", id}),
    update: (data) =>dispatch({type: "UPDATE_LAMBOR_SUV_REQUEST", data})
  };
};
