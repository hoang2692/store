...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    onDelete: (id) =>dispatch({type: "DELETE_MER_COPEE_REQUEST", id:id}),
    AddSanPham: (data) =>dispatch({type: "ADD_MER_COPEE_REQUEST", data}),
    getEditData: (id) => dispatch({type:"GETEDIT_MER_COPEE_REQUEST", id}),
    update: (data) =>dispatch({type: "UPDATE_MER_COPEE_REQUEST", data})
  };
};
