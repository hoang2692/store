...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    onDelete: (id) => dispatch({ type:"DELETE_TOYOTA_SUVTOYOTAS_REQUEST", id:id}),
    AddSanPham: (data) =>dispatch({type: "ADD_TOYOTA_SUVTOYOTAS_REQUEST", data}),
    getEditData: (id) => dispatch({type:"GETEDIT_TOYOTA_SUVTOYOTAS_REQUEST", id}),
    update: (data) =>dispatch({type: "UPDATE_TOYOTA_SUVTOYOTAS_REQUEST", data})
  };
};
