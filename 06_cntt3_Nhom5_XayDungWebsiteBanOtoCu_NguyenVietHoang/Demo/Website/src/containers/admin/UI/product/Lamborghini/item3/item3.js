          ...
          return (
            ...
            <td>
              <div class="row" style={{justifyContent: "center"}}>
                ...
                <a className="btn btn-danger" role="button" onClick={() =>this.onDelete(e.id)}>Delete</a>
              </div>
            </td>
          </tr>
          )
...
const mapStateToProps = (state) => {
  return {
    products: state.HarucanLambor.data,
    dataEdit: state.EditLambor.data
  };
};

const mapDispatchToProps = (dispatch) => {
  return {
    getData: () =>dispatch({type: "GET_LAMBOR_HARUCAN_REQUEST"}),
    onDelete: (id) =>dispatch({type: "DELETE_LAMBOR_HARUCAN_REQUEST", id:id}),
    AddSanPham: (data) =>dispatch({type: "ADD_LAMBOR_HARUCAN_REQUEST", data}),
    getEditData: (id) => dispatch({type:"GETEDIT_LAMBOR_HARUCAN_REQUEST", id}),
    update: (data) =>dispatch({type: "UPDATE_LAMBOR_HARUCAN_REQUEST", data})
  };
};
