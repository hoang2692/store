...
const mapStateToProps = (state) => {
  return {
    products: state.aventadorLambor.data,
...
const mapDispatchToProps = (dispatch) => {
  return {
    getData: () =>dispatch({type: "GET_LAMBOR_AVENTADOR_REQUEST"}),
    onDelete: (id) => dispatch({type: "DELETE_LAMBOR_AVENTADOR_REQUEST", id:id}),
    AddSanPham: (data) =>dispatch({type: "ADD_LAMBOR_AVENTADOR_REQUEST", data}),
    getEditData: (id) => dispatch({type:"GETEDIT_LAMBOR_AVENTADOR_REQUEST", id}),
    update: (data) =>dispatch({type: "UPDATE_LAMBOR_AVENTADOR_REQUEST", data})
  };
};
