...
const mapStateToProps = (state) => {
  return {
    products: state.SaloonsMer.data,
    dataEdit: state.EditMer.data
  };
};

const mapDispatchToProps = (dispatch) => {
  return {
    getData: () =>dispatch({type: "GET_MER_SALOONS_REQUEST"}),
    onDelete: (id) =>dispatch({ type: "DELETE_MER_SALOONS_REQUEST", id:id}),
    AddSanPham: (data) =>dispatch({type: "ADD_MER_SALOONS_REQUEST", data}),
    getEditData: (id) => dispatch({type:"GETEDIT_MER_SALOONS_REQUEST", id}),
    update: (data) =>dispatch({type: "UPDATE_MER_SALOONS_REQUEST", data})
  };
};
